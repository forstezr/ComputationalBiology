function [motif, probs, finalState, finalScores, states] = runTrial(numIterations, windowSize, state, sequences, initialScore, states)    
    %sequences = DPalign();
    ...
    %Run for solution
    [finalState, finalScores, finalStates] = itrMotifs(state, initialScore, numIterations, windowSize, states);
